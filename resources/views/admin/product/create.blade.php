            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="precio" id="precio" aria-describedby="helpId" placeholder="precio"required>
                    </div>
                    {{-- <div class="form-group">
                    ...
                    <div class="custom-file mb-4">
                        <input type="file" name="picture" class="custom-file-input" id="picture" lang="es">
