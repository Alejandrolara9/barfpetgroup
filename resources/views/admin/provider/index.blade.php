                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="btn-group dropleft">
                                <a href="{{route('providers.create')}}" class="btn btn-primary" type="button">Agregar</a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="table-responsive">
                                <table id="providers" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            <th>Id</th>
                                            <th>Nombre</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 5%;">
                                                ...
                                                <a href="{{route('providers.edit', $provider)}}" tilte="Editar"><i class="far fa-edit"></i></a>
