...
class UpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            // 'email'=>'required|string|max:255|unique:providers,email,'.
            // $this->route('provider')->id.'|max:255',

            // 'nit'=>'required|string|max:15|min:9|unique:providers,nit,'.
            // $this->route('provider')->id.'|max:15',
            // 'celular'=>'required|string|max:15|min:9|unique:providers,celular'.
            // $this->route('provider')->id.'|max:15',
        ];
    }
